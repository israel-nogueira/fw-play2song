...
CREATE DEFINER=`root`@`localhost` TRIGGER INSERT__TEMPLATE__AREAS_ATUACAO AFTER INSERT ON TEMPLATE__AREAS_ATUACAO
		FOR EACH ROW BEGIN
			SET @permitir_atualizacao= 1;
			INSERT INTO TEMPLATE__AREAS_ATUACAO__TRANSLATE (TITULO,DESCRICAO, ID_FW_PAI, FW_LANG) VALUES (NEW.TITULO,NEW.DESCRICAO, NEW.ID, 'pt');
...
CREATE DEFINER=`root`@`localhost` TRIGGER UPDATE__TEMPLATE__AREAS_ATUACAO AFTER UPDATE ON TEMPLATE__AREAS_ATUACAO FOR EACH ROW		BEGIN
			...
			IF  @record_count > 0 THEN 
				...
				WHERE ID_FW_PAI = NEW.ID AND FW_LANG = NEW.FW_LANG; 
			ELSE
				INSERT INTO TEMPLATE__AREAS_ATUACAO__TRANSLATE ( TITULO,DESCRICAO, ID_FW_PAI, FW_LANG) VALUES ( NEW.TITULO,NEW.DESCRICAO,NEW.ID, NEW.FW_LANG);
			END IF; 
...
CREATE DEFINER=`root`@`localhost` TRIGGER `UPDATE__TEMPLATE__STATIC` AFTER UPDATE ON `TEMPLATE__STATIC` FOR EACH ROW BEGIN
			...
			IF  @record_count > 0 THEN 
                ...
                WHERE ID_FW_PAI = NEW.ID AND FW_LANG = NEW.FW_LANG; 
			ELSE
				INSERT INTO TEMPLATE__STATIC__TRANSLATE ( MENU_LABEL_HOME,MENU_LABEL_EMPRESA,MENU_LABEL_ATUACAO,MENU_LABEL_DOC,MENU_LABEL_CLIENTES,MENU_LABEL_CASES,MENU_LABEL_CONTATO,MENU_LINK_HOME,MENU_LINK_EMPRESA,MENU_LINK_ATUACAO,MENU_LINK_DOC,MENU_LINK_CLIENTES,MENU_LINK_CASES,MENU_LINK_CONTATO,HEADER_NEWSLETTER_TITULO,HEADER_NEWSLETTER_DESC,HEADER_PLACEHOLDER,HEADER_ABOUT_TITULO,HEADER_ABOUT_DESC,HEADER_TELEFONE,HEADER_ENDERECO,HEADER_NEWSLETTER_BUTTON,HEADER_COPYRIGHT,FOOTER_NEWSLETTER_TITULO,FOOTER_NEWSLETTER_DESC,FOOTER_PLACEHOLDER,FOOTER_ABOUT_TITULO,FOOTER_ABOUT_DESC,FOOTER_TELEFONE,FOOTER_ENDERECO,FOOTER_NEWSLETTER_BUTTON,FOOTER_COPYRIGHT,FOOTER_LINK_COPYRIGHT, ID_FW_PAI, FW_LANG,TITULO_AREAS) VALUES ( NEW.MENU_LABEL_HOME,NEW.MENU_LABEL_EMPRESA,NEW.MENU_LABEL_ATUACAO,NEW.MENU_LABEL_DOC,NEW.MENU_LABEL_CLIENTES,NEW.MENU_LABEL_CASES,NEW.MENU_LABEL_CONTATO,NEW.MENU_LINK_HOME,NEW.MENU_LINK_EMPRESA,NEW.MENU_LINK_ATUACAO,NEW.MENU_LINK_DOC,NEW.MENU_LINK_CLIENTES,NEW.MENU_LINK_CASES,NEW.MENU_LINK_CONTATO,NEW.HEADER_NEWSLETTER_TITULO,NEW.HEADER_NEWSLETTER_DESC,NEW.HEADER_PLACEHOLDER,NEW.HEADER_ABOUT_TITULO,NEW.HEADER_ABOUT_DESC,NEW.HEADER_TELEFONE,NEW.HEADER_ENDERECO,NEW.HEADER_NEWSLETTER_BUTTON,NEW.HEADER_COPYRIGHT,NEW.FOOTER_NEWSLETTER_TITULO,NEW.FOOTER_NEWSLETTER_DESC,NEW.FOOTER_PLACEHOLDER,NEW.FOOTER_ABOUT_TITULO,NEW.FOOTER_ABOUT_DESC,NEW.FOOTER_TELEFONE,NEW.FOOTER_ENDERECO,NEW.FOOTER_NEWSLETTER_BUTTON,NEW.FOOTER_COPYRIGHT,NEW.FOOTER_LINK_COPYRIGHT,NEW.ID, NEW.FW_LANG,NEW.TITULO_AREAS);
			END IF; 
