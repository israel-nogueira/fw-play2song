	var configsScript = function (url, params) {
		return {
			url: url,
			params: params,
			reload: async function () { 
				...
				ajax({
					csrfKey: 'configs',
					url: '/api/configs/get-configs',
					method: 'POST',
					recaptcha: false,
					success: function (response) {

						$('.template-content-footer input[name="WHATSAPP"]').val((response.response['WHATSAPP']||''));
						$('.template-content-footer input[name="FONE"]').val((response.response['FONE']||''));
						$('.template-content-footer input[name="LINKEDIN"]').val((response.response['LINKEDIN']||''));
						$('.template-content-footer input[name="EMAIL"]').val((response.response['EMAIL']||''));
						$('.template-content-footer input[name="EMAIL_FORM"]').val((response.response['EMAIL_FORM']||''));
