...
{{-- BLOCOS DE TEMPLATE --}}
@include('project.franquias.template')

<!-- CSS EXTERNO  -->
<link rel="stylesheet/css" type="text/css" href="/project/franquias/franquiasStyle.min.css" />
...
<script  typ="text/javascript" src="/project/franquias/franquiasScript.js?v={{CACHE}}"></script>
<script type="text/javascript">
	...
	window.modulo['{ajax-href}']	= franquiasScript('{ajax-href}',params);
</script>
