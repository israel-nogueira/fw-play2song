<?
	...
	use project\sinaisTelegram\sinaisTelegramModel;
	use IsraelNogueira\galaxyDB\galaxyDB;
	use IsraelNogueira\SkySession\session;

	/*
	|--------------------------------------------------------------------
	|	CLASSE GERAL DO MÓDULO "sinaisTelegram"
	|--------------------------------------------------------------------
	*/

	class sinaisTelegramClass{
		public function 		__construct(){}
		public function 		__get($a){}
		public function 		__set($a,$b){}
		public function 		__call($a,$b){}
		public static function __callStatic($a,$b){}
		public static function index(){return sinaisTelegramModel::index();}
