...
VALUES ('21', '4899293551239047', '674105368613986', 'NOVO');

INSERT INTO GALERIAS__IMAGENS (ID, UID, UID_PLUGIN, UID_GALERIA, FILENAME, ORIGINAL_NAME, MIME, PESO, 50x50, 100x100, 300x300, 550x550)
VALUES ('51', '2257174656979854', '674105368613986', '4899293551239047', 'a9ee7e405cfdb2a306b02102778b79d2.png', '5.jpg', 'image/jpeg', '92960', 'a9ee7e405cfdb2a306b02102778b79d2-50x50x100.png', 'a9ee7e405cfdb2a306b02102778b79d2-100x100x100.png', 'a9ee7e405cfdb2a306b02102778b79d2-300x300x100.png', 'a9ee7e405cfdb2a306b02102778b79d2-550x550x100.png');
...
INSERT INTO GALERIAS__PLUGIN (ID, UID, TITULO, SLUG, MULTIPLAS, TAMANHO_THUMB)
VALUES ('13', '674105368613986', '3333333', '', '1', '50x50,100x100,300x300,550x550');

INSERT INTO MIDIA__BANNER (ID, ID_PLUGIN, LINK, TARGET, ANALITYCS, CLICKTAG, TITULO, DESCRICAO, STATUS, INICIA, TERMINA)
VALUES ('70', '23', NULL, '_Self', '0', NULL, 'BANNER_02', '', '1', '1969-12-31 00:00:00', '1969-12-31 00:00:00');

INSERT INTO MIDIA__FILES (ID, ID_BANNER, ID_PLUGIN, NOME_ORIGINAL, PATH, FILENAME, MEDIA_QUERY, SIZE, TYPE)
VALUES ('278', '70', '23', '425.png', 'PLUGIN_23/BANNER_70', 'cb3a36f126a0de4e659161616080e516.png', '425', '185710', 'image/png');

INSERT INTO MIDIA__FILES (ID, ID_BANNER, ID_PLUGIN, NOME_ORIGINAL, PATH, FILENAME, MEDIA_QUERY, SIZE, TYPE)
VALUES ('279', '70', '23', '768.png', 'PLUGIN_23/BANNER_70', 'a4e394931a25dc7b3787b312f926584a.png', '768', '409255', 'image/png');

INSERT INTO MIDIA__FILES (ID, ID_BANNER, ID_PLUGIN, NOME_ORIGINAL, PATH, FILENAME, MEDIA_QUERY, SIZE, TYPE)
VALUES ('280', '70', '23', '1024.png', 'PLUGIN_23/BANNER_70', '44f828998f24717fb96aa041ff4ed4b4.png', '0', '535506', 'image/png');

INSERT INTO MIDIA__FILES (ID, ID_BANNER, ID_PLUGIN, NOME_ORIGINAL, PATH, FILENAME, MEDIA_QUERY, SIZE, TYPE)
VALUES ('281', '70', '23', '1440.png', 'PLUGIN_23/BANNER_70', 'ac38c15d3d93863985023c80bf572e2d.png', '1440', '734627', 'image/png');

INSERT INTO MIDIA__FILES (ID, ID_BANNER, ID_PLUGIN, NOME_ORIGINAL, PATH, FILENAME, MEDIA_QUERY, SIZE, TYPE)
VALUES ('282', '70', '23', '1920.png', 'PLUGIN_23/BANNER_70', '3373f7dd19372258615e8ec43d569f9a.png', '1920', '820746', 'image/png');
...
INSERT INTO TEMPLATE__STATIC (ID, MENU_LABEL_HOME, MENU_LABEL_EMPRESA, MENU_LABEL_ATUACAO, MENU_LABEL_DOC, MENU_LABEL_CLIENTES, MENU_LABEL_CASES, MENU_LABEL_CONTATO, MENU_LINK_HOME, MENU_LINK_EMPRESA, MENU_LINK_ATUACAO, MENU_LINK_DOC, MENU_LINK_CLIENTES, MENU_LINK_CASES, MENU_LINK_CONTATO, HEADER_NEWSLETTER_TITULO, HEADER_NEWSLETTER_DESC, HEADER_PLACEHOLDER, HEADER_ABOUT_TITULO, HEADER_ABOUT_DESC, HEADER_TELEFONE, HEADER_ENDERECO, HEADER_NEWSLETTER_BUTTON, HEADER_COPYRIGHT, FOOTER_NEWSLETTER_TITULO, FOOTER_NEWSLETTER_DESC, FOOTER_PLACEHOLDER, FOOTER_ABOUT_TITULO, FOOTER_ABOUT_DESC, FOOTER_TELEFONE, FOOTER_ENDERECO, FOOTER_NEWSLETTER_BUTTON, FOOTER_COPYRIGHT, FOOTER_LINK_COPYRIGHT, FW_LANG)
VALUES ('1', 'Inicio', 'Sobre nós', 'Áreas de atuação ', 'Documentação', 'Clientes', 'Cases', 'Contato', '/', '/sobre-nos', '/areas-de-atuacao', '/documentacao', '/clientes', '/cases-de-sucesso', '/contato2', '11111', '222222', '3333333', '4444444', '555555', '6666666', '77777', '888888', '9999999', 'CADASTRE-SE', 'Receba nossa newsletter especial', 'Seu melhor e-mail', 'Fale conosco', 'Mauris non nisi semper, lacinia neque in, dapibus leo. Curabitur sagittis libero tincidunt tempor finibus. Mauris at dignissim ligula, nec tristique orci.Quisque vitae metus', '1800-121-3637 +91 555 234-8765', '380 St Kilda Road, Melbourne VIC 3004, Australia', 'Cadastre-se já', 'NJ2 Company', '', 'pt');

INSERT INTO TEMPLATE__STATIC__TRANSLATE (ID, FW_LANG, ID_FW_PAI, MENU_LABEL_HOME, MENU_LABEL_EMPRESA, MENU_LABEL_ATUACAO, MENU_LABEL_DOC, MENU_LABEL_CLIENTES, MENU_LABEL_CASES, MENU_LABEL_CONTATO, MENU_LINK_HOME, MENU_LINK_EMPRESA, MENU_LINK_ATUACAO, MENU_LINK_DOC, MENU_LINK_CLIENTES, MENU_LINK_CASES, MENU_LINK_CONTATO, HEADER_NEWSLETTER_TITULO, HEADER_NEWSLETTER_DESC, HEADER_PLACEHOLDER, HEADER_ABOUT_TITULO, HEADER_ABOUT_DESC, HEADER_TELEFONE, HEADER_ENDERECO, HEADER_NEWSLETTER_BUTTON, HEADER_COPYRIGHT, FOOTER_NEWSLETTER_TITULO, FOOTER_NEWSLETTER_DESC, FOOTER_PLACEHOLDER, FOOTER_ABOUT_TITULO, FOOTER_ABOUT_DESC, FOOTER_TELEFONE, FOOTER_ENDERECO, FOOTER_NEWSLETTER_BUTTON, FOOTER_COPYRIGHT, FOOTER_LINK_COPYRIGHT)
VALUES ('1', 'pt', '1', 'Inicio', 'Sobre nós', 'Áreas de atuação ', 'Documentação', 'Clientes', 'Cases', 'Contato', '/', '/sobre-nos', '/areas-de-atuacao', '/documentacao', '/clientes', '/cases-de-sucesso', '/contato2', '11111', '222222', '3333333', '4444444', '555555', '6666666', '77777', '888888', '9999999', 'CADASTRE-SE', 'Receba nossa newsletter especial', 'Seu melhor e-mail', 'Fale conosco', 'Mauris non nisi semper, lacinia neque in, dapibus leo. Curabitur sagittis libero tincidunt tempor finibus. Mauris at dignissim ligula, nec tristique orci.Quisque vitae metus', '1800-121-3637 +91 555 234-8765', '380 St Kilda Road, Melbourne VIC 3004, Australia', 'Cadastre-se já', 'NJ2 Company', '');

INSERT INTO TEMPLATE__STATIC__TRANSLATE (ID, FW_LANG, ID_FW_PAI, MENU_LABEL_HOME, MENU_LABEL_EMPRESA, MENU_LABEL_ATUACAO, MENU_LABEL_DOC, MENU_LABEL_CLIENTES, MENU_LABEL_CASES, MENU_LABEL_CONTATO, MENU_LINK_HOME, MENU_LINK_EMPRESA, MENU_LINK_ATUACAO, MENU_LINK_DOC, MENU_LINK_CLIENTES, MENU_LINK_CASES, MENU_LINK_CONTATO, HEADER_NEWSLETTER_TITULO, HEADER_NEWSLETTER_DESC, HEADER_PLACEHOLDER, HEADER_ABOUT_TITULO, HEADER_ABOUT_DESC, HEADER_TELEFONE, HEADER_ENDERECO, HEADER_NEWSLETTER_BUTTON, HEADER_COPYRIGHT, FOOTER_NEWSLETTER_TITULO, FOOTER_NEWSLETTER_DESC, FOOTER_PLACEHOLDER, FOOTER_ABOUT_TITULO, FOOTER_ABOUT_DESC, FOOTER_TELEFONE, FOOTER_ENDERECO, FOOTER_NEWSLETTER_BUTTON, FOOTER_COPYRIGHT, FOOTER_LINK_COPYRIGHT)
VALUES ('2', 'en', '1', '1111111', '222222222', '4444444', '5666666', '888888', 'aaaa', 'cccccc', '1111', '3333333', '55555', '777777', '99999', 'bbbbbb', 'ddddddd', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'aaaaaaaaa', 'sssssss', 'fffffffff', 'ggggg', 'hhhhhhh', 'jjjjj', 'kkkk', 'dddddd', 'llllll', 'lçççççççç');

INSERT INTO TEMPLATE__STATIC__TRANSLATE (ID, FW_LANG, ID_FW_PAI, MENU_LABEL_HOME, MENU_LABEL_EMPRESA, MENU_LABEL_ATUACAO, MENU_LABEL_DOC, MENU_LABEL_CLIENTES, MENU_LABEL_CASES, MENU_LABEL_CONTATO, MENU_LINK_HOME, MENU_LINK_EMPRESA, MENU_LINK_ATUACAO, MENU_LINK_DOC, MENU_LINK_CLIENTES, MENU_LINK_CASES, MENU_LINK_CONTATO, HEADER_NEWSLETTER_TITULO, HEADER_NEWSLETTER_DESC, HEADER_PLACEHOLDER, HEADER_ABOUT_TITULO, HEADER_ABOUT_DESC, HEADER_TELEFONE, HEADER_ENDERECO, HEADER_NEWSLETTER_BUTTON, HEADER_COPYRIGHT, FOOTER_NEWSLETTER_TITULO, FOOTER_NEWSLETTER_DESC, FOOTER_PLACEHOLDER, FOOTER_ABOUT_TITULO, FOOTER_ABOUT_DESC, FOOTER_TELEFONE, FOOTER_ENDERECO, FOOTER_NEWSLETTER_BUTTON, FOOTER_COPYRIGHT, FOOTER_LINK_COPYRIGHT)
VALUES ('3', 'es', '1', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
