...
$('#contact-form4').on('submit',function(e){
	...
	ajax({
		csrfKey: 'contatosSite',
		url: '/api/newsletter/novo',
		method: 'POST',
		private: data,
		recaptcha: true,
		fila: true,
		...
		success: function (response, status, xhr) {
			$('.newslater-area .alert-success').show();
			$('#contact-form4')[0].reset();
			setTimeout(function(){
				$('.newslater-area .alert-success').hide();
			},3000)
		},
...
$('#form-contato').on('submit',function(e){
	...
	ajax({
		...
		beforeSend:function (xhr) {},
		success: function (response, status, xhr) {
			$('#form-contato .alert-success').show();
			$('#form-contato')[0].reset();
			setTimeout(function(){
				$('#form-contato .alert-success').hide();
			},3000)
		},
		error:function (errorMsg, xhr) {},
		done:function (xhr) {},
