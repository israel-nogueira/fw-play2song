//----------------------------------------------------------
//	DEFININDO A CLASSE recompensasScript
//----------------------------------------------------------
if (typeof recompensasScript != "function") {

	var	recompensasScript = function (url, params) {
		return {
			url: url,
			params: params,
	...
	console.danger("A função recompensasScript já existe")
