...
{{-- ------------------------------- --}}
		...
		<div class="col-sm-12 col-md-offset-1 col-md-10 col-lg-offset-2 col-lg-11">
				<div class="card custom-card mt-4">
					...
					<div class="card-body">
						<div class="container">
							<div class="row">
								<div class="h2 fw-semibold mb-0 col-sm-5">PLUGIN DE GALERIAS</div>
								...
								<div class="dropdow col-xs-6 col-sm-3 mt-1">
									<div class="btn-group d-flex w-100 my-2 my-sm-0"> 
										<button class="btn btn-icon btn-secondary add-midia-plugin" data-bs-toggle="tooltip">
											<i class="bi bi-plus-square m-2"></i> Novo Plugin
										</button>
									</div>
								</div>
							</div>
	...
	<script		type="text/javascript" src="/project/galeria/plugin/galeriaPluginScript.js?v={{CACHE}}"></script>
	...
	<script type="text/javascript">
		...
		@csrfToken('galeriaPluginScript')
		@csrfToken('officeCRSF')
		@csrfToken('testeUpload')
		var params						= {prefixo:'{{$prefix}}'};
		window.modulo['{ajax-href}']	= galeriaPluginScript('{ajax-href}',params);
	</script>
