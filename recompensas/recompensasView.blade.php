...
{{-- BLOCOS DE TEMPLATE --}}
@include('project.recompensas.template')

<!-- CSS EXTERNO  -->
<link rel="stylesheet/css" type="text/css" href="/project/recompensas/recompensasStyle.min.css" />
...
<script  typ="text/javascript" src="/project/recompensas/recompensasScript.js?v={{CACHE}}"></script>
<script type="text/javascript">
	@csrfToken('recompensas')
	var params						= {
		prefixo:'{{$prefix}}',
		modulo:'recompensas',
	};
	window.modulo['{ajax-href}']	= recompensasScript('{ajax-href}',params);
</script>
