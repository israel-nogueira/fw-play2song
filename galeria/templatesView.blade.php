...
--}}
	...
	<template id="{{$prefix}}_lista_galerias">
		<li>
			<div class="d-flex align-items-top flex-wrap">
				...
				<div class="flex-fill">
					<p class="fw-semibold mb-0">[TITULO]</p>
					<span class="text-muted fs-12">/office/galerias/[UID]</span>
				</div>
					<div class="fw-semibold fs-15 m-1">
						<div data-uidplugin="[UID_PLUGIN]" data-uidgaleria="[UID]" class="btn btn-danger delete-galeria"> Excluir </div>
					</div>
				<div class="fw-semibold fs-15 m-1">
					<a data-uidplugin="[UID_PLUGIN]" data-uidgaleria="[UID]"  class="btn btn-secondary config-galeria-galerias"> Configurar </a>
				</div>
				<div class="fw-semibold fs-15 m-1">
					<a href="/office/galerias/[UID_PLUGIN]/[UID]" class="btn btn-success"> EDITAR IMAGENS </a>
				</div>
			</div>
		</li>
	...
	<template id="{{$prefix}}_lista_plugin_galeria">
		<li>
			<div class="d-flex align-items-top flex-wrap">
				<div class="me-2 d-none">
					<span class="avatar avatar-sm avatar-rounded">
				...
				<div class="flex-fill">
					...
					<div class="fw-semibold fs-15 m-1">
						<div data-idplugin="[UID]"class="btn btn-danger delete-plugin"> Excluir </div>
					</div>
				<div class="fw-semibold fs-15 m-1">
					<a data-idplugin="[UID]" class="btn btn-secondary config-plugin-galeria"> Configurar </a>
				</div>

				[#GALERIAS]
					<div class="fw-semibold fs-15 m-1">
						<a href="/office/galerias/[UID]" class="btn btn-success"> EDITAR GALERIAS </a>
					</div>
				[/GALERIAS]

				[#IMAGENS]
					<div class="fw-semibold fs-15 m-1">
						<a href="/office/galerias/[UID]/[UID_GALERIA]" class="btn btn-success"> EDITAR GALERIA </a>
					</div>
				[/IMAGENS]

				[#IMAGEM]
					<div class="fw-semibold fs-15 m-1">
						<a href="/office/galerias/[UID]/[UID_GALERIA]/[UID_IMG]" class="btn btn-success"> EDITAR IMAGEM </a>
					</div>
				[/IMAGEM]
	...
	<template id="{{$prefix}}_files_banners">
		<div>
			<li>
				<div class="container">
					<div class="row">
						<div class="col-sm-12">
							<p class="fw-semibold text-left">[NOME_ORIGINAL]</p>
						</div>
								
						<form class="col-sm-12 col-md-10 p-0">
							<div class="row">
								
								<input  type="radio" class="btn-check" name="query_radio_banner" value="320" 		id="[ID]_btnradio_8"/>
								<label class="col m-1 btn btn-outline-primary"	for="[ID]_btnradio_8">320</label>

								<input  type="radio" class="btn-check" name="query_radio_banner" value="375" 		id="[ID]_btnradio_7"/>
								<label class="col m-1 btn btn-outline-primary"	for="[ID]_btnradio_7">375</label>

								<input  type="radio" class="btn-check" name="query_radio_banner" value="425" 		id="[ID]_btnradio_6"/>
								<label class="col m-1 btn btn-outline-primary"	for="[ID]_btnradio_6">425</label>

								<input  type="radio" class="btn-check" name="query_radio_banner" value="768" 		id="[ID]_btnradio_5"/>
								<label class="col m-1 btn btn-outline-primary"	for="[ID]_btnradio_5">768</label>

								<input  type="radio" class="btn-check" name="query_radio_banner" value="1024" 		id="[ID]_btnradio_4"/>
								<label class="col m-1 btn btn-outline-primary"	for="[ID]_btnradio_4">1024</label>

								<input  type="radio" class="btn-check" name="query_radio_banner" value="1440" 		id="[ID]_btnradio_3"/>
								<label class="col m-1 btn btn-outline-primary"	for="[ID]_btnradio_3">1440</label>

								<input  type="radio" class="btn-check" name="query_radio_banner" value="1920" 		id="[ID]_btnradio_2"/>
								<label class="col m-1 btn btn-outline-primary"	for="[ID]_btnradio_2">1920</label>

								<input  type="radio" class="btn-check" name="query_radio_banner" value="2560" 		id="[ID]_btnradio_1"/>
								<label class="col m-1 btn btn-outline-primary"	for="[ID]_btnradio_1">2560</label>
						...
						<div class="col-sm-12 col-md-2 d-flex justify-content-center align-items-center">
							<div class="btn btn-block btn-danger btn-delete-img-banner" data-id="[ID]"> Excluir </div>
						</div>
					</div>
				</div>
	...
	<template id="{{$prefix}}_lista_banners">
		<li>
			<div class="d-flex align-items-top flex-wrap">
				<div class="me-2 d-none">
					<span class="avatar avatar-sm avatar-rounded">
				...
				<div class="flex-fill">
					<p class="fw-semibold mb-0">[TITULO]</p>
					<span class="text-muted fs-12">/office/midia/plugin/[ID]</span>
				</div>
				@if (@$MULTIPLOS==1)
					<div class="fw-semibold fs-15 m-1">
						<a data-idbanner="[ID]" class="btn btn-danger excluir-banner"> Excluir </a>
					</div>
				@endif
				<div class="fw-semibold fs-15 m-1">
					<a data-idbanner="[ID]" class="btn btn-secondary detalhes-banner"> Configurar </a>
				</div>
				<div class="fw-semibold fs-15 m-1">
					<a href="/office/midia/filebanner/[ID_PLUGIN]/[ID]" class="btn btn-success"> Gerenciar </a>
				</div>
			</div>
		</li>
	...
	<template id="{{$prefix}}_lista_table">
		<li>
			<div class="d-flex align-items-top flex-wrap">
				...
				@endif
				<div class="fw-semibold fs-15 m-1">
					<a data-idbanner="[ID]" class="btn btn-secondary config-banner"> Configurar </a>
				</div>
				<div class="fw-semibold fs-15 m-1">
					<a href="/office/midia/banners/[ID]" class="btn btn-success"> Gerenciar </a>
				</div>
			</div>
		</li>
	...
	<template id="{{$prefix}}_lista_carrinho">
		<tr>
			...
			<td class="product-quantity-container">
				<div class="input-group border rounded flex-nowrap"> <button class="btn btn-icon btn-light input-group-text flex-fill product-quantity-minus"><i class="ri-subtract-line"></i></button>
				<input type="text" class="form-control form-control-sm border-0 text-center w-100" aria-label="quantity" id="{{$prefix}}_product-quantity" value="2">
				<button class="btn btn-icon btn-light input-group-text flex-fill product-quantity-plus"> 
	...
	<template id="{{$prefix}}_lista_thumb">
		<div class="col-sm-4 col-md-3">
			<div class="gal-detail thumb">
				<div class="overlayThumb">
					<div class="titulo">[TITULO]</div>
					<div class="descricao">[DESCRICAO]</div>
					<div class="original">[ORIGINAL_NAME]</div>
				</div>
				<div class="delete-thumb" data-uidthumb="[UID]"><i class="bi bi-x-square-fill"></i></div>
				<div class="detalhes-thumb" data-uidthumb="[UID]"><i class="bi bi-search"></i></div>
				<img src="/project/public/upload/galerias/PLUGIN_[UID_PLUGIN]/GALERIA_[UID_GALERIA]/[300x300]" class="thumb-img" alt="work-thumbnail" />
			</div>
		</div>
	</template>
					...
					<div class="dados1 d-flex flex-wrap align-item-center mt-sm-0 mt-5 justify-content-between p-3">
						<div class="team-member-details flex-fill">
							<p class="mb-0 fw-semibold fs-16 text-truncate">
								<a href="/office/usuario/detalhes/[UID]">[NOME]</a>
							</p>
						...
						<div class="dropdown d-none">
							...
							<ul class="dropdown-menu">
								<li><a class="dropdown-item" href="/office/usuario/detalhes/[UID]" ><i style="margin-right: 10px;" class="bi bi-person-bounding-box"></i>Acessar profile</a></li>
